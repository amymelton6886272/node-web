...
export function About(){
  ...
  return <>
    ...
    <RichSection title={data.contactTitle} className="contactPanel">
      ...
      <div className="legalLinkRow"><strong>{data.linksTitle}</strong><a href="/privacy" onClick={e=>{e.preventDefault();history.pushState({},'','/privacy');window.dispatchEvent(new PopStateEvent('popstate'))}}>Privacy</a><a href="/disclaimer" onClick={e=>{e.preventDefault();history.pushState({},'','/disclaimer');window.dispatchEvent(new PopStateEvent('popstate'))}}>Disclaimer</a><a href="/knowledge" onClick={e=>{e.preventDefault();history.pushState({},'','/knowledge');window.dispatchEvent(new PopStateEvent('popstate'))}}>Knowledge</a><a href="/checklists" onClick={e=>{e.preventDefault();history.pushState({},'','/checklists');window.dispatchEvent(new PopStateEvent('popstate'))}}>Checklists</a></div>
    </RichSection>
  </>;
}
...
export function Contact(){
  ...
  return <>
    ...
    <section className="legal card">
      <div className="legalLinkRow"><strong>Important pages:</strong><a href="/privacy" onClick={e=>{e.preventDefault();history.pushState({},'','/privacy');window.dispatchEvent(new PopStateEvent('popstate'))}}>Privacy Policy</a><a href="/disclaimer" onClick={e=>{e.preventDefault();history.pushState({},'','/disclaimer');window.dispatchEvent(new PopStateEvent('popstate'))}}>Disclaimer</a><a href="/about" onClick={e=>{e.preventDefault();history.pushState({},'','/about');window.dispatchEvent(new PopStateEvent('popstate'))}}>About</a></div>
    </section>
  </>;
}
