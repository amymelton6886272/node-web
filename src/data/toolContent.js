export const toolContent = {
  en: {
    ...
    appfree: {
      ...
      links: [{ href: '#price', label: 'Price Compare' }, { href: '#iap', label: 'Check IAP' }, { href: '#guides', label: 'Free app guide' }],
      linksLabel: 'Related reading'
    },
    iap: {
      ...
      links: [{ href: '#price', label: 'App base price' }, { href: '#guides', label: 'Subscription safety guide' }, { href: '#glossary', label: 'IAP terms' }],
      linksLabel: 'Related reading'
    },
    icon: {
      ...
      links: [{ href: '#guides', label: 'App identification guide' }, { href: '#glossary', label: 'Bundle ID and icon terms' }],
      linksLabel: 'Related reading'
    },
    ip: {
      ...
      links: [{ href: '#knowledge', label: 'Network safety guide' }, { href: '#privacy', label: 'Privacy Policy' }],
      linksLabel: 'Related reading'
    },
    address: {
      ...
      links: [{ href: '#ip', label: 'IP Check' }, { href: '#privacy', label: 'Privacy Policy' }],
      linksLabel: 'Related reading'
    }
  },
  zh: {
