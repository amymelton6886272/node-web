export const toolContent = {
  en: {
    ...
    address: {
      ...
      intro: 'The address generator is for front-end development tests, UI layout mockups, demo data, and academic research. Generated content stays in your browser unless you export it.',
      notice: 'Important: Addresses generated by this tool are for front-end development testing, interface layout, and academic research only. Do not use them for real registrations, billing, identity claims, fraud, or any illegal activity.',
      items: [
