...
const routeMeta = {
  '/': {
    en: ['Wolffy - Apple / iOS Toolkit', 'Compare App Store prices, discover free apps, search icons, check IP details, and read practical Apple safety guides.'],
    zh: ['Wolffy - Apple / iOS 工具箱', '提供 App Store 跨区价格对比、限免应用发现、图标搜索、IP 检测、测试地址生成和 Apple 安全指南。'],
  },
  '/price': {
    en: ['App Store Subscription Compare - Wolffy', 'Search an app once, then compare the app itself and public subscription prices across regions.'],
    zh: ['App Store 订阅比价 - Wolffy', '搜索一次应用后，对比软件本体与公开订阅项目在多个热门地区的价格。'],
  },
  '/appfree': {
  ...
  '/address': {
    ...
    zh: ['地址生成器 - Wolffy', '在本地生成测试地址数据，用于表单、界面演示和开发调试。'],
  },
  '/guides': {
    ...
    zh: ['App Store 使用指南 - Wolffy', '阅读订阅、隐私、退款、家庭设备和跨区决策相关的实用指南。'],
  },
  '/knowledge': {
    ...
    zh: ['Apple 安全知识库 - Wolffy', '以通俗语言整理权限、隐私标签、订阅、退款和常见风险内容。'],
  },
  '/checklists': {
    ...
    zh: ['决策清单 - Wolffy', '在购买应用、开始订阅、检查隐私或切换地区前使用实用清单。'],
  },
  '/glossary': {
    ...
    zh: ['App Store 术语表 - Wolffy', '理解 Bundle ID、IAP、TestFlight、价格等级和家庭共享等常见术语。'],
  },
  '/risk': {
  ...
  '/articles': {
    ...
    zh: ['文章 - Wolffy', '围绕购买、隐私、账号和 App Store 决策的实用文章。'],
  },
};
