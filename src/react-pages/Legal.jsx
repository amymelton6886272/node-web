...
const policyPages = {
  terms: {
    ...
    sections: [
      { title: '1. Acceptance of terms', text: 'By accessing Wolffy, you agree to use the site for lawful, personal, research, educational, and development-support purposes. If you do not agree with these terms, do not use the site.' },
      { title: '2. Informational tools only', text: 'Wolffy provides App Store research tools, safety explanations, checklists, and generated test data. Results are not guarantees, professional advice, purchase recommendations, legal advice, financial advice, or approval from Apple or any third-party service.' },
      ...
      { title: '4. Prohibited use', text: 'Do not use Wolffy to facilitate fraud, impersonation, unauthorized access, credential sharing, account abuse, platform circumvention, spam, scraping that harms services, or misuse of generated addresses for delivery, billing, identity verification, or deception.' },
      ...
      { title: '6. Changes', text: 'Wolffy may update tools, content, data sources, advertising integrations, and these terms as the site evolves. Continued use after updates means you accept the revised terms.' },
    ],
  },
  editorial: {
    title: 'Editorial Policy',
    sub: 'How Wolffy writes, reviews, labels, and corrects content for users researching Apple and App Store decisions.',
    effective: 'Effective date: 2026-06-16',
    sections: [
      { title: '1. Purpose', text: 'Wolffy publishes practical, cautious, and verifiable content for Apple and iOS users. The goal is to help readers understand app pricing, subscriptions, permissions, refunds, privacy labels, regional differences, and common safety risks before taking action.' },
      { title: '2. Independence', text: 'Wolffy is independent and is not affiliated with Apple, Google, GitHub, Docker, app developers, payment providers, or advertising networks mentioned on the site. Trademarks and service marks belong to their respective owners.' },
