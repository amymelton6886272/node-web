...
const staticRoutes = [
  ...
  { path: '/contact', changefreq: 'monthly', priority: '0.7', lastmod: '2026-07-10' },
  { path: '/privacy', changefreq: 'monthly', priority: '0.6', lastmod: '2026-07-14' },
  { path: '/disclaimer', changefreq: 'monthly', priority: '0.5', lastmod: '2026-06-20' },
  { path: '/terms', changefreq: 'monthly', priority: '0.6', lastmod: '2026-06-20' },
  { path: '/editorial', changefreq: 'monthly', priority: '0.5', lastmod: '2026-07-08' },
  { path: '/data-sources', changefreq: 'monthly', priority: '0.5', lastmod: '2026-07-11' },
  ...
  { path: '/iap', changefreq: 'weekly', priority: '0.8', lastmod: '2026-07-13' },
  { path: '/icon', changefreq: 'weekly', priority: '0.7', lastmod: '2026-07-09' },
  { path: '/ip', changefreq: 'monthly', priority: '0.7', lastmod: '2026-07-07' },
